...
function noA (arr){
   ...
   if(arr[i][0].toLowerCase() === 'a') result.push('###');
...
function no3and5 (num){
    const result = [];
   for(let i = 0; i < num.length; i++) {
    if(num[i] % 3 === 0 && num[i] % 5 === 0 ) result.push(101);
    else if(num[i] % 3 === 0)  result.push(100);
    else if(num[i] % 5 === 0)  result.push(99);
