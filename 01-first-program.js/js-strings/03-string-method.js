...
let secondLastChar = company[8]; //or let secondLastCHar = company [company.length - 2]
...
///Tricky part with property acces
console.log(company[-1]); //undefined
console.log(company[10]); //undefined
console.log(company[0.99]); //undefined not make sens
...
/*TASK:used to rerietve/get a character at specified index
RETURN: it returns a single 
ARGUMENT: */
