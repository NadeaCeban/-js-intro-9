...
const sumOfNumbers1 = numbers.reduce((sum, number) => {
   return sum + number;
}, 0);

console.log(sumOfNumbers1); // 11
...
const elementHasApple = fruits.reduce(( count, currentFruit) =>{
   if(currentFruit.toLowerCase().includes('apple'))  return count+1;
   else return count;
},0)
console.log(elementHasApple);


const elementHasI = fruits.reduce(( count, currentFruit) =>{
    if(currentFruit.toLowerCase().indexOf('i') >= 0)  return count+1;
    else return count;
 },0)
 console.log(elementHasI);

 const elementEndWithE = fruits.reduce(( count, currentFruit) =>{
    if(currentFruit.toLowerCase().indexOf('e') >= 0)  return count+1;
    else return count;
 },0)
 console.log(elementEndWithE);
